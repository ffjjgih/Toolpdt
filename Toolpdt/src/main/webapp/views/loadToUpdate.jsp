        ...
        <div class="container">
            ...
            <form action="updatekht" method="post">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-7">
                        <input type="text" value = "${detail.ngayThi }" name = "ngaythi" class="form-control input_control" id="inputPassword">
                    </div>
                </div>
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-7">
                        <input type="text" value = "${detail.giangVien }" name = "giaovien" class="form-control input_control" id="inputPassword">
                    </div>
                </div>
                <div class="mb-3 row">
